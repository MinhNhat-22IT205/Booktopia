...
export default function Contact() {
  ...
  if (!isLoaded) return <div className="mt-10 text-6xl">Loading...</div>;
  return (
    <div className="grid grid-cols-12 ">
      ...
      <div className="row-span-2 max-w-[600px] lg:ml-[-120px] lg:mt-[-150px] mb-20 py-8 px-5 col-start-2 col-span-10 lg:col-start-8 lg:col-span-3 rounded-xl z-15 bg-white scale-110 shadow-lg shadow-[#6c5dd4]">
        <ContactForm />
      </div>
    </div>
  );
