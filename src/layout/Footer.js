        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full pl-4 sm:w-2/3 lg:w-3/12">
            <div className="mb-10 w-full">
              <a alt="" href="#a" className="mb-6 inline-block max-w-[160px]">
                <h1 className="font-bold text-3xl">Booktopia</h1>
              </a>
              ...
              <p className="text-dark flex items-center text-sm font-medium">
                <span className="text-primary mr-3 text-[#6c5dd4]">
                  <svg
                    width="19"
                    height="21"
                    viewBox="0 0 19 21"
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
            <div className="mb-10 w-full">
              ...
              <p className="text-body-color text-base">&copy; 2025 Booktopia</p>
            </div>
          </div>
        </div>
      </div>
