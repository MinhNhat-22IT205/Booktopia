...
export default function ListProduct(props) {
  ...
  return (
    <Link
      to={`/books/${props.id}`}
      className="p-3 border rounded-xl flex justify-between my-3 hover:shadow-xl hover:scale-105 transition-all hover:shadow-[#d4d0fe]"
    >
      <img
        className="h-[245px] w-[175px] rounded-xl object-cover"
        src={props.image}
        alt=""
      />
      <div className="relative flex flex-col justify-center w-full ml-8 mr-5">
        ...
        <h2 className="uppercase text-[#6c5dd4] my-2 text-xs">
          {props.genre.join(", ")}
        </h2>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center justify-between">
            ...
            <div className="mx-10">
              <h3 className="text-[#aaaaaa] text-sm">Created</h3>
              <h1 className="text-lg font-semibold">{props.date}</h1>
            </div>
          </div>
