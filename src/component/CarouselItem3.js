...
export default function carouselItem3(props) {
  return (
    <div className="block  lg:flex bg-white w-fit rounded-xl mx-10 my-10 opacity-50 scale-90">
      <img className="mr-10 rounded-xl w-[21rem]" alt="" src={props.link}></img>
      <div className="ml-10  w-[280px] lg:w-[500px] pt-10 pr-5 pb-10">
        ...
        <div className="mt-5">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.9 }}
            className="ml-4 border-2 border-[#aeaeb1]  text-lg font-semibold px-5 py-3 rounded-lg "
          >
            See Details
          </motion.button>
        </div>
